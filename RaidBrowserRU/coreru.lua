	...
	{ -- зс хм
		...
		patterns = std.algorithm.copy_back(
			...
			{ 
				...
				'в'..csep..'зс'..csep..'хм',
				'в'..csep..'ЗС'..csep..'хм',
			"%[Кривой Клык: Змеиное святилище%]"..csep..'хм',
			}
		),
	},
	{ -- зс 
		...
		patterns = std.algorithm.copy_back(
			...
			'в'..csep..'зс',
			'в'..csep..'ЗС'..csep..'об',
			"%[Кривой Клык: Змеиное святилище%]"..csep..'об',
			}
		),
	},
...
local gearscore_patterns = {
	...
	'пару','хил','дд','танк','танки','+','[0-99999]*','все','рдд',
